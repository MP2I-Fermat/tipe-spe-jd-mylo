...
\setbeamertemplate{headline}{
  ...
  \begin{beamercolorbox}[ht=0.42cm, vmode]{section in head/foot}
    \insertshorttitle -- {\initiales} -- {\insertshortdate}
    \vspace*{0.08cm}
  \end{beamercolorbox}
  % la deuxième ligne
...
\setbeamertemplate{frametitle}{
    ...
    \begin{beamercolorbox}[ht=0.8cm, wd=\paperwidth, vmode]{frametitle}
      \hspace{0.3cm} \insertframetitle \vspace*{0.1cm} \\[-0.5cm]
    \end{beamercolorbox}
}
...
\newcommand{\pointeur}[0]{\raisebox{-3pt}{$\uparrow$}}
\newcommand{\pointeurbleu}[0]{\raisebox{-3pt}{$\color{blue}\uparrow$}}
