...
\begin{algorithm}[H]
    ...
    \Sortie{
        ...
        indiquant le prochain nom de variable non utilis\'e, et telle que le
        dernier couple $(p, e)$ de la forme renvoy\'ee est telle que $p$ est un
        motif identifiant qui prendra la valeur de $e$ lors de l'\'ex\'ecution
        de $l$.
    }
    ...
    $l_1, k_1 \leftarrow \textnormal{Lin\'eariser}(e_1, k)$ \\
    $l_2, k_2 \leftarrow \textnormal{Lin\'eariser}(e_1, k_1)$ \\
...
\begin{proof}
    Par induction sur $e$.
    \newline
    On traitera trois cas, les autres cas \'etant tous tr\`es similaires.
        ...
        \item Si $e$ est une addition $e_1$ + $e_2$ : \\
              ...
              \begin{itemize}
                  ...
                  \item $e' = [(\_, a_1)] + [(\_, a_2)]$ : \\
                        ...
                        sont réduits \`a un seul couple avec $a_1$ et $a_2$ sont
        ...
        \item Si $e$ est une conditionnelle \texttt{if} $e_1$ \texttt{then} $e_2$ \texttt{else} $e_3$ : \\
              ...
              \begin{itemize}
                  ...
                  \item $e' = \textnormal{\texttt{if}}\ [(\_, a_1)]\ \textnormal{\texttt{then}}\ l_2\ \textnormal{\texttt{else}}\ l_3$ : \\
                        ...
                        $[(\_, a_1)]$ est réduit \`a un seul couple avec $a_1$
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item Si $e$ est une addition $e_1$ + $e_2$ : \\
              Supposons que les formes linéaires $l_1$ et $l_2$ renvoyées par
              Linéariser($e_1$, $k$) et Linéariser($e_2$, $k$) correspondent \`a
              ...
              correspondent \`a $e_1$ et $e_2$, c'est équivalent \`a évaluer
