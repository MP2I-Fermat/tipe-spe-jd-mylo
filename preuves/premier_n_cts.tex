...
Puisque notre grammaire ne contient pas de r\`egles $N \rightarrow \varepsilon$,
on peut d\'efinir les suites
...
\begin{center}
    ...
    $\begin{aligned}
             & \begin{aligned}
                   premier_{n+1}(N) = & \thinspace premier_n(N) \cup \bigcup_{N \rightarrow \overrightarrow{\alpha}} premier_n(\overrightarrow{\alpha}) \\
    ...
    \item Soit $k \in \mathbb{N}$ et supposons $P(k)$ vrai. Alors~:
          \par $\begin{aligned}
                  ...
                  =                    & \thinspace premier_n(N) \bigcup_{N \rightarrow \overrightarrow{\alpha}} premier_n(\overrightarrow{\alpha})         \\
                                       & \thinspace \text{\small (d'apr\`es $P(k)$)}                                                                        \\
